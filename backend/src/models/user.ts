...
// User identities table - for OAuth providers (PassportJS pattern)
export const userIdentities = pgTable('user_identities', {
  ...
  providerUserIdIdx: uniqueIndex('provider_user_id_idx').on(table.provider, table.provider_user_id),
}));
